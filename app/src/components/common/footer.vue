  ...
  <footer>
    <div class="footer-wrap">
      <div class="footer-inner-top">
        <svg width="66" height="17" class="footer-logo">
          <path
        ...
        <div class="footer-inner-com">
          ...
          <div class="footer-sns-wrap">
            <a href="#" class="footer-sns-button"
              ><svg width="40" height="40" class="footer-sns-items">
                <path
      ...
      <div class="footer-inner-bottom">
        ...
        <div class="footer-info-tap">
          <p>
            ...
            주소&#58; 서울시 강남구 역삼동 702-28 어반벤치빌딩 10층 (테헤란로
            325)<br />

            사업자등록번호 &#58; 120-87-27435 &#47; 통신판매번호 &#58; 제
            2009-서울강남 35-02139호<br />

            이메일 &#58; contact@laftel.net &#47; 대표전화 &#58; 1644-0331
          </p>
        </div>
      </div>
    </div>
